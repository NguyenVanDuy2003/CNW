<?php
    ...
    include "../../config/createSQL/index.php";
    include "../../extension/snack.php";

    if (isset($_GET['Login'])) {
        echo showSnack("Duy ngu ngốc =))");
    } 
?>
        ...
        <div class="box-shadow pd-20 w-30 gap-20 column ai-center pdUD-30 box-login bd-radius-10">
            ...
            <div class="w-full">
                <form method="get" actions="" class="w-full gap-20 d-flex">
                    <button class="btn w-haft pd-15 <?php if (!isset($_GET['btnRegister'])) { echo 'btn-focus'; } ?>" name="btnLogin">login</button>
                    <button class="btn w-haft pd-15 <?php if (isset($_GET['btnRegister'])) { echo 'btn-focus'; } ?>" name="btnRegister">register</button>
                </form>
            </div>
            ...
            <?php
                if (!isset($_GET['btnRegister'])) {
                    ...
                    echo '<form class="column w-full gap-10 ai-center">
                    <input type="text" placeholder="Full name" class="input-basic w-full"/>
                    <input type="email" placeholder="Email" class="input-basic w-full"/>
                    <input type="text" placeholder="Username" class="input-basic w-full"/>
                    <input type="password" placeholder="Password" class="input-basic w-full"/>
                    <input type="password" placeholder="Confirm Password" class="input-basic w-full"/>
