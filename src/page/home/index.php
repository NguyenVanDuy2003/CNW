                    ...
                    foreach ($courses as $index => $courseM) {
                        if ($count > 9) {
                            ...
                            if (in_array($userId, $students) || in_array($userId, $teachers)) {
                                ...
                                <div class="subtitle-course d-flex jc-spacebetween" style="background-image: url(' . (($courseM['cover'] == 'https://cst.hnue.edu.vn/theme/space/pix/default_course.jpg') ? $courseM['cover'] : '../../../images/upload/' . $courseM['cover']) . ');">
                                    <div class="d-flex">';                            
